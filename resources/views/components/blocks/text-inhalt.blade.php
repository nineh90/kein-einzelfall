{{-- Inhalt eines Textabschnitts, ohne eigene Fläche und ohne Seitenrand.

     Eigene Komponente, weil ihn drei Hüllen brauchen: x-blocks.text (ein
     einzelner Abschnitt als Band), x-blocks.artikel (mehrere Abschnitte
     hintereinander als ein Artikel) und x-blocks.nebeneinander (kurze
     Abschnitte auf der Startseite als Spalten). Siehe PageBlock::abschnitte(). --}}
@props([
    'eyebrow' => null,
    'titel' => null,
